...
const piAnswersList: [string, IntakeAnswer][] = [
  ...
  ans("date-location", "incidentLocation", "Intersection of 4th St & Alameda Ave, Springvale, NY"),
  ...
  ans("insurance", "insuranceInfo", "Own policy with Coastline Auto Insurance, policy #NY-88213."),
  ...
  ans("deadlines", "jurisdiction", "New York"),
...
export function buildDemoClaim1(): Claim {
  ...
  const claim: Claim = {
    ...
    deadlineLabel: "New York personal injury statute of limitations (approx.)",
...
const empAnswersList: [string, IntakeAnswer][] = [
  ...
  ans("employer-info", "employerLocation", "Riverton, NY distribution center"),
  ...
  ans("jurisdiction", "jurisdiction", "New York"),
...
export const DEMO_FAQ: FaqItem[] = [
  ...
  { id: "faq-6", question: "How does Review My Claim work?", answer: "Review My Claim analyzes the completeness and consistency of the information you've entered — such as dates, evidence, witnesses, and timeline detail — to produce a transparent readiness score and suggested next steps.", category: "Review My Claim" },
  { id: "faq-7", question: "Does a high score guarantee success?", answer: "No. The score reflects how complete and organized your intake is, not the strength or likely outcome of a legal claim. Only a licensed lawyer can assess the merits of your case.", category: "Review My Claim" },
  { id: "faq-8", question: "Is the score shared with lawyers?", answer: "Your score is included in your claim summary and is only shared with a lawyer if you choose to request a consultation and consent to share it.", category: "Review My Claim" },
  ...
  { id: "faq-15", question: "What jurisdictions are supported?", answer: "This MVP demonstrates a New York-based example. A production version would expand jurisdiction coverage and tailor deadline information accordingly.", category: "General" },
