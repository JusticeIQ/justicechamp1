...
const SECTIONS = [
  { title: "Not a law firm", body: "JusticeChamp is a technology platform, not a law firm, and does not provide legal representation. Use of JusticeChamp does not create an attorney-client relationship with JusticeChamp or SolonIQ." },
  { title: "Informational purpose only", body: "Content, including the Review My Claim assessment, is preliminary and informational. It is not legal advice and does not guarantee any legal outcome, settlement value, or that any lawyer will accept your matter." },
  ...
  { title: "Limitation of liability", body: "JusticeChamp and SolonIQ are provided on an \"as is\" basis and disclaim liability to the fullest extent permitted by law for decisions made based on information provided through the platform." },
